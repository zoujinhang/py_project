...
for i in range(len(sample_list)):
	...
	result1 = accumulate_counts(t_c,c_rate*dt,np.sqrt(bin_n),w,startedges,stopedges,txx = 0.9,it = 300,lamd = 1/dt)#bn191221802
	#result1 = accumulate_counts(t_c,c_rate*dt,np.sqrt(bin_n),w,startedges,stopedges,txx = 0.9,it = 300,lamd = 10/dt)
	txx = result1['txx']
	...
	result1['t_c'] = t_c
	result1['rate'] = c_rate
	result1['bs'] = WhittakerSmooth(c_rate,w,lambda_=10/dt)
	result1['good'] = True
	result1['sigma'] = sigma
