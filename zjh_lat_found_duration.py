...
plt.savefig(savedir + 'A_lightcurve.pdf')
plt.close()


plt.figure()
plt.subplot(1,1,1)
plt.plot(t_c,rate_sm,label = 'lightcurve')
plt.step(edges,re_rate1,color = 'k',label = 'bayesian blocks')
#plt.step(edges,re_rate1+re_sigma1,color = 'y')
#plt.step(edges,re_rate1-re_sigma1,color = 'y')
plt.axhline(y = background_mean,color = 'r',label = 'background')
#plt.axhline(y = background_mean-background_sigma,color = 'r')
#plt.axhline(y = background_mean+background_sigma,color = 'r')
plt.ylim(0,5000)
plt.legend()
...
plt.savefig(savedir + 'A_lightcurve1.pdf')
plt.close()
...
fig.savefig(savedir + 'C_SNR_lightcurve.pdf')
plt.close(fig)
